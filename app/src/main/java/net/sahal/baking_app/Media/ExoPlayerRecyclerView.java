...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        int currentPosition =
                targetPosition - ((LinearLayoutManager) Objects.requireNonNull(getLayoutManager())).findFirstVisibleItemPosition();
        ...
        StepsAdapter.RecyclerMediaViewHolder holder = (StepsAdapter.RecyclerMediaViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
